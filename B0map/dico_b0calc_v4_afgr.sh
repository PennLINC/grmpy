...
do_skullstrip=1	    # Skull-strip magnitude B0map image
...
do_demean=1         # de-mean the rpsmap
do_despike=1        # de-spike the rpsmap
force_RPI=1         # force result to be RPI
...
shift $(($OPTIND - 1))
#t1whole="/data/joy/BBL/studies/pnc/rawData/99991/*x6217/mprage/99991_*x6217_t1.nii.gz"
#t1brain="/data/joy/BBL/studies/pnc/processedData/structural/antsCorticalThickness/99991/*x6217/ExtractedBrain0N4.nii.gz"
...
#EXECDIR=`dirname $0`
EXECDIR="/data/joy/BBL/applications/scripts/bin/"
if [ "X${EXECDIR}" != "X" ]; then
...
#dcmfiles=( `ls /data/joy/BBL/studies/pnc/rawData/99991/*x6217/B0MAP_S006/*dcm /data/joy/BBL/studies/pnc/rawData/99991/*x6217/B0MAP_S007/*dcm` )
#ndcm=${#dcmfiles[@]}
## optargs work around down here for reg T1 to extracted T1
dcmfiles=( `ls ${1}/*.dcm ${2}/*.dcm` )
ndcm=${#dcmfiles[@]}
t1whole=${3}
t1brain=${4}
