...
#$ -o /cbica/projects/pncNmf/n1396_t1NMF/results/GMD/extractBasesMT.$JOB_ID.stdout
#### save the standard error:
#$ -e /cbica/projects/pncNmf/n1396_t1NMF/results/GMD/extractBasesMT.$JOB_ID.stderr
####
#### My email address:
#$ -M Robert.Jirsaraie@ucdenver.edu
...
#$ -l h_vmem=40G,s_vmem=40.0G -q qlogin.himem.q 
#### 
...
/bin/echo "Command: /cbica/projects/pncNmf/grmpyNMF/n115_structCT/scripts/extractBasesMT*"
...
/bin/echo "Command: /cbica/projects/pncNmf/grmpyNMF/n115_structCT/scripts/extractBasesMT*" 1>&2
/bin/echo "Arguments: List of input files: $1 NumBases: $2 Output Directory: $3 mask: $4"
...
extractBasesMT=/cbica/projects/pncNmf/grmpyNMF/n115_structCT/scripts/extractBasesMT*
