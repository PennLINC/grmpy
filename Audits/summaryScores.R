...
grumpy2<-read.csv("/home/rjirsaraie/grmpyData/ImagingScalesSTAISTA_DATA_2017-12-06_2132.csv")
...
grumpy<-read.csv("/home/rjirsaraie/grmpyData/BBLSelfreportAndStat_DATA_2017-12-06_2027.csv")
...
subs<-read.csv("/data/joy/BBL/projects/grmpyProcessing2017/structural/struct_pipeline/n118_Cohort_20170911.csv", header=FALSE)
grumpy<-grumpy[ which(grumpy$bblid %in% subs$V1) , ]
...
demo<-read.csv("/home/rjirsaraie/grmpyData/GRMPYDataEntryInterv_DATA_2017-12-06_2038.csv")
demo[demo ==-9999] <- NA 
subs<-read.csv("/data/joy/BBL/projects/grmpyProcessing2017/structural/struct_pipeline/n118_Cohort_20170911.csv", header=FALSE)
