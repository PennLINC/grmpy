...
#########################################################################################
    ################       GRMPY n118 Multi-Sequence Audit         ###############
    ################              Robert Jirsaraie                 ###############
    ################             rjirsara@upenn.edu                ###############
    ################                 07/19/2017                    ###############
#########################################################################################
...
This script can determine if subjects are missing images from multiple sequences. 
A text file will output which lists all the subjectIDs that are missing a given sequence. 
