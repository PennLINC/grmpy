###################################################################################################
##########################        GRMPY - Merge Dataset From RedCap      ##########################
##########################               Robert Jirsaraie                ##########################
...
subjects<-read.csv("/data/joy/BBL/projects/grmpyProcessing2017/NMF/n115_Cohort_20171015.csv")
Demographics<-read.csv("/data/joy/BBL/projects/grmpyProcessing2017/NMF/Demographics.csv")
ARI<-read.csv("/data/joy/BBL/projects/grmpyProcessing2017/NMF/Irritability.csv")
...
write.csv(finalSubjects, paste('/data/joy/BBL/projects/grmpyProcessing2017/Audits/n115_Psychometrics_',
