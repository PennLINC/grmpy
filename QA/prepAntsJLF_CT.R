...
system("mv /data/joy/BBL/studies/grmpy/processedData/structural/struct_pipeline_20170716/antsCT_JLF_vals.1D /data/joy/BBL/projects/grmpyProcessing2017/QA/structural/") 
...
ctValues <- read.table("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/antsCT_JLF_vals.1D", header=T)
...
write.csv(ctValues, paste('/data/joy/BBL/projects/grmpyProcessing2017/QA/CT/n118_jlfAntsCTIntersectionCt_',format(Sys.Date(), format="%Y%m%d"),'.csv', sep=''), quote=F, row.names=F)
