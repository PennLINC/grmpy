...
JLFVol <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/n118_jlfAntsCTIntersectionVol_20170911.csv")
CTVol <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/n118_AntsCTVol_20170911.csv")
JLF_CT <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/n118_jlfAntsCTIntersectionCT_20170911.csv")
JLF_GMD <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/n118_jlfAntsCTIntersectionGMD_20170911.csv")
norm <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/n118_NormQuality_20170826.csv")
bblid_scanid_datexscanid <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/autoQA/n118_BBL_ScanID_Date_DatexScanID.csv")
...
dataJLF <- read.csv("/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/n118_jlfAntsCTIntersectionVol_20170911.csv")
...
write.csv(dataFinal, "/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/autoQA/n118_structQAFlags_20170913.csv",row.names=FALSE)
