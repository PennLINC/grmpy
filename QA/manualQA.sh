...
outfiledir="/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/manualQA/n118_T1ManualQA_.csv"
outfile="${outfiledir}/${appendOut1}outfile${appendOut2}.csv"
infile="/data/joy/BBL/projects/grmpyProcessing2017/QA/structural/manualQA/n113_MPRAGEsubjectpaths_20170715.txt"
